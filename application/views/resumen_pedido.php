...
<html lang="es">
    <head>
        ...
        <title>Resumen del pedido | R-Shop</title>
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="total_area">
                                ...
                                <a class="btn btn-default success update" href="<?= site_url('Carrito/agregar_pedido'); ?>">Efectuar pedido</a>
                                <a class="btn btn-default info update" href="<?= site_url('Carrito'); ?>">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
